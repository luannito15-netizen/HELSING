...
Este é o **projeto Unity oficial e ativo** do HELSING (ÚNICO projeto de produção).

## Estado real (confirmado em disco)
- Unity 6000.5.8f1 (projeto já criado e aberto pelo Editor — `Library/`, `Temp/`, `Logs/`, `.csproj`, `unity.slnx` existem).
- URP 17.5.0.
- Input System 1.20.0.
...
Nome recomendado:
`Prototype_Arena_01` (ainda não criada).

## Primeiro milestone
Ver `../handoff/HANDOFF_TO_VSCODE.md`.
